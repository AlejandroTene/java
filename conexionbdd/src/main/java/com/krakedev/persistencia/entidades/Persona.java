...
public class Persona {
	...
	private Date horaNacimeinto;
	
	public Persona() {
		
	}
	public Persona(String cedula, String nombre, String apellido, EstadoCivil estadoCivil, int numeroHijos,
			double estatura, BigDecimal cantidadAhorrada, Date fechaNacimiento, Date horaNacimeinto) {
		super();
		this.cedula = cedula;
		this.nombre = nombre;
		...
		this.horaNacimeinto = horaNacimeinto;
	}
	...
	public Date getHoraNacimeinto() {
		return horaNacimeinto;
	}
	public void setHoraNacimeinto(Date horaNacimeinto) {
		this.horaNacimeinto = horaNacimeinto;
	}
	@Override
	public String toString() {
		return "Persona [cedula=" + cedula + ", nombre=" + nombre + ", apellido=" + apellido + ", estadoCivil="
				...
				+ cantidadAhorrada + ", fechaNacimiento=" + fechaNacimiento + ", horaNacimeinto=" + horaNacimeinto
				+ "]";
	}
